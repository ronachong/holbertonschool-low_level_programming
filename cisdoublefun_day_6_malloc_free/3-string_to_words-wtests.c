...
char **assign_letters(char *s, int start_position, int current_index, int words_in_array, char **outer_array) {
  ...
  if (outer_array[current_index] == NULL) {
    ...
    printf("current_index is %d. words_in_array is %d. num_letters is %d. num_nonletters is %d.\n", current_index, words_in_array, num_letters, num_nonletters);
